    ...
    <div style={{
      ...
      <div style={{ padding: "18px 22px" }}>
        <div style={{ background: "#fff", border: "1px solid #dce5ef", borderRadius: 6, overflow: "hidden" }}>
          ...
          {/* Campaign title */}
          <div style={{ padding: "10px 18px", borderBottom: "1px solid #edf1f6", display: "flex", alignItems: "center", gap: 12 }}>
            <input
              value={campaignName}
                ...
                <div style={{ display: "flex", gap: 16, marginBottom: 24 }}>
                  ...
                  <div className="summary-card" style={{ flex: 1 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                      <span style={{ fontSize: 20, fontWeight: 600, color: budgetMatch ? "#1e7e34" : "#b71c1c" }}>
                        {fmt(tacticTotal)}
                      </span>
                      <span className={`match-badge ${budgetMatch ? "match-ok" : "match-err"}`}>
                        {budgetMatch
                          ? "✓ Balanced"
                          : `${fmt(Math.abs(totalBudget - tacticTotal))} ${tacticTotal > totalBudget ? "over" : "under"}`}
                      </span>
                    </div>
                    <div className="bar-track">
                      <div className="bar-fill" style={{
                        ...
                        background: budgetMatch
                          ? "linear-gradient(90deg, #43a85a, #66cc7a)"
                          : "linear-gradient(90deg, #3a6ea8, #5a9fd4)",
                      }} />
                    </div>
                  </div>
                </div>
                  ...
                  {tactics.map((t, i) => {
                    ...
                    return (
                      <div key={i} className="tactic-row">
                        ...
                        <div className="cell" style={{ textAlign: "right", color: p > 0 ? "#1a3a6a" : "#c5d3e0", fontWeight: p > 0 ? 500 : 400 }}>
                          {pct(p)}
                        </div>
                  ...
                  {tactics.filter(t => (parseFloat(t.budget) || 0) > 0 || t.name.trim()).map((t, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="cell" style={{ textAlign: "right", fontWeight: 500, color: monthly > 0 ? "#1a5276" : "#aab8c8" }}>
                          {monthly > 0 ? fmt(monthly) : "—"}
                        </div>
                        <div className="cell" style={{ textAlign: "right", color: p > 0 ? "#1a3a6a" : "#aab8c8" }}>
                          {pct(p)}
                        </div>
                      </div>
                    );
